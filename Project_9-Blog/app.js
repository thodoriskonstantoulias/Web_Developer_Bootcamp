...
app.post("/compose", function(req,res){
  ...
  //Insert the post to mongo database
...
//We use lodash to convert any string to lowercase and any blank with a dash
app.get("/posts/:postId", function(req,res){
  //Exercise : if the request param of url is contained in any blog title console match found 
  //Final : when the above is true render to post page with the associated post
  // posts.forEach(function(post){
  //   if (_.lowerCase(post.title) === _.lowerCase(req.params.something)){
  //     res.render("post", {post : post});
  //   }
  // });

  //Using the mongoDB we make the id as route parameter 
